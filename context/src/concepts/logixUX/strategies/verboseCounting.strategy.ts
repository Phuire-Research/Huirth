...
export const logixUXVerboseCountingStrategyTopic = (length: number): string =>
  `logixUX will randomly count and iterate upon a number starting from zero, ${logixUX_convertNumberToStringVerbose(length)} times`;
