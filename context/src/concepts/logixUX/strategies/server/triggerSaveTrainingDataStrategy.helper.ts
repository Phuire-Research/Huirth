/*<$
For the framework Stratimux and a Concept logixUX, for the client generate a helper action that will trigger the save training data strategy on the server.
$>*/
/*<#*/
