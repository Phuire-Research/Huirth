...
export const logixUXGenerateVerboseCountingStrategy = prepareActionCreator(logixUXGenerateVerboseCountingStrategyType);

const logixUXGenerateVerboseCountingStrategyMethodCreator: MethodCreator = (concepts$) =>
