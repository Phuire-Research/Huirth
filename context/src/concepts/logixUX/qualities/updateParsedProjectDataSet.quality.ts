...
export const [logixUXUpdateParsedProjectDataSet, logixUXUpdateParsedProjectDataSetType, logixUXUpdateParsedProjectDataSetQuality] =
  createQualitySetWithPayload<LogixUXUpdateParsedProjectDataSetPayload>({
    type: 'logixUX update parsed project data set',
