...
export const logixUXInnerCountBy = prepareActionWithPayloadCreator<LogixUXInnerCountByPayload>(logixUXInnerCountByType);
    ...
    if (action.strategy) {
      ...
      if (data) {
        ...
        strategy.currentNode.actionType =
          logixUX_convertNumberToStringVerbose(count) + ' ' + action.type + ' by ' + logixUX_convertNumberToStringVerbose(countBy);
...
export const logixUXInnerCountByQuality = createQuality(logixUXInnerCountByType, defaultReducer, logixUXInnerCountByMethodCreator);
/*#>*/
