...
export const [logixUXSetPossibleProject, logixUXSetPossibleProjectType, logixUXSetPossibleProjectQuality] = createQualitySet({
  type: 'logixUX set the possible project and check if it is valid',
