...
$>*/
/*<#*/
import { ActionType, createQuality, nullReducer, prepareActionCreator } from 'stratimux';
...
export const userInterfaceEndQuality = createQuality(userInterfaceEndType, nullReducer);
/*#>*/
