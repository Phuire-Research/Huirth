...
export const webSocketClientSyncStateType: ActionType = 'Web Socket sync State';
export const webSocketClientSyncState = prepareActionWithPayloadCreator<WebSocketClientSyncStatePayload>(webSocketClientSyncStateType);
