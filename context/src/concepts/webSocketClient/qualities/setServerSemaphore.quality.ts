...
export const webSocketClientSetServerSemaphoreType: ActionType = 'Web Socket Client set Server Semaphore';
export const webSocketClientSetServerSemaphore = prepareActionWithPayloadCreator<WebSocketClientSetServerSemaphorePayload>(
