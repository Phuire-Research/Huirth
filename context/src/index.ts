          ...
          [
            ...
            createDocumentObjectModelConcept({
              index: {
                ...
                '#addID': [
                  {
                    action: { type: 'Counter Add', semaphore: [0, 0, -1, 0], expiration: 1699897711644 },
                    eventBinding: 'onclick',
                  },
                ],
                '#subtractID': [
                  {
                    action: { type: 'Counter Subtract', semaphore: [0, 0, -1, 0], expiration: 1699897711644 },
                    eventBinding: 'onclick',
                  },
                ],
              },
