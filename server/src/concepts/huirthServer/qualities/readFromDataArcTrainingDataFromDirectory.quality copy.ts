...
export type ReadFromDataArcTrainingDataFromDirectoriesField = {
  trainingData: TrainingData;
};

export const huirthServerReadFromDataArcTrainingDataFromDirectories = createQualityCard({
  type: 'huirth Server read Arc Training Data from File System Data, Directories and Files',
  reducer: nullReducer,
  methodCreator: () =>
