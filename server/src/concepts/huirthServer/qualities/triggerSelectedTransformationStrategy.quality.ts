    ...
    createMethodDebounce(
      (act) => {
        ...
        case huirthVerboseAddingStrategySelect: {
          action = huirthServerGenerateVerboseAddingStrategy(undefined, undefined, 6000000000000);
          break;
        }
        case huirthVerboseSubtractionStrategySelect: {
          action = huirthServerGenerateVerboseSubtractionStrategy(undefined, undefined, 6000000000000);
          break;
        }
        case huirthVerboseAdditionAndSubtractionStrategySelect: {
          action = huirthServerGenerateVerboseAdditionAndSubtractionStrategy(undefined, undefined, 6000000000000);
          break;
        }
        default: {
          break;
