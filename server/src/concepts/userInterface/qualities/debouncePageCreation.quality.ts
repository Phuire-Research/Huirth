...
export const userInterfaceDebouncePageCreationType: ActionType =
  'User Interface Debounce Page Creation Strategies';
export const userInterfaceDebouncePageCreation = prepareActionCreator(userInterfaceDebouncePageCreationType);

const userInterfaceDebouncePageCreationMethodCreator = () => createMethodDebounce((action) => {
  if (action.strategy) {
